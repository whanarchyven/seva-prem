    ...
    <div className={'p-4 flex flex-col items-center justify-center gap-12'}>
      ...
      <div
        ...
        <div
          ...
          />
          <img className={'xl:w-auto w-2/3 xl:h-full'} src={'/images/forwho1.png'} />
          <div
            className={
              'for-who-text-grad w-full rounded-2xl -mt-10 p-8 flex flex-col gap-3'
            }>
            <p className={'uppercase text-center text-3xl xl:text-4xl font-phil'}>
              для пар
            </p>
            <p className={'text-center text-[#393939] text-base xl:text-xl font-montserrat'}>
        ...
        <div
          className={
            'w-full xl:w-1/3 2xl:w-[36rem] rounded-2xl flex relative justify-center items-center flex-col aspect-square for-who-footage'
          }>
          <img
            src={'/images/forwho_footage2.png'}
            className={'w-full h-full absolute left-0 top-0 z-0'}
          />
          <img className={'xl:w-auto w-2/3 xl:h-full'} src={'/images/forwho2.png'} />
          <div
            className={
              'for-who-text-grad w-full rounded-2xl -mt-10 p-8 flex flex-col gap-3'
            }>
